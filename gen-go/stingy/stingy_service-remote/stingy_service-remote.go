...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  string GetQuote()")
...
func main() {
	...
	client := stingy.NewStingyServiceClientFactory(trans, protocolFactory)
	...
	case "GetQuote":
		if flag.NArg()-1 != 0 {
			fmt.Fprintln(os.Stderr, "GetQuote requires 0 args")
			flag.Usage()
		}
		fmt.Print(client.GetQuote())
		fmt.Print("\n")
		break
	case "ping":
		if flag.NArg()-1 != 0 {
	...
	case "CheckServiceHealth":
		if flag.NArg()-1 != 0 {
			fmt.Fprintln(os.Stderr, "CheckServiceHealth requires 0 args")
			flag.Usage()
		}
		fmt.Print(client.CheckServiceHealth())
		fmt.Print("\n")
		break
	case "getInfo":
		if flag.NArg()-1 != 0 {
